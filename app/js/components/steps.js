    ...
    return {
      ...
      link : function (scope, element) {
        scope.$on('LastElem', function(event){
          var compiled = _.template('<svg  class="prev" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 100 100" height="100" id="Layer_1" version="1.1" viewBox="0 0 100 100" width="100" xml:space="preserve">'+
